...
def save_images(inputs, targets, outputs, folder_name, epoch, num_images=5):
    ...
    for i in range(num_images):
        ...
        print(f"Input shape: {input_img_np.shape}, Target shape: {target_img_np.shape}, Output shape: {output_img_np.shape}")

        # Check the dimensions before concatenation
        if input_img_np.shape[0] != target_img_np.shape[0] or input_img_np.shape[0] != output_img_np.shape[0]:
